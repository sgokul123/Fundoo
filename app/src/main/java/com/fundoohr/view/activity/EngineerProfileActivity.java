...
public class EngineerProfileActivity extends AppCompatActivity implements EnggViewModelInterface {
    ...
    private static String TAG ="EngineerProfileActivity";
    TextView mId, mStatus, mCompany, mMobile, mEmail, mBLStart, mCompanyStart, mCompanyLeave, mLeave,mTextViewName;
    Context context;
    //CollapsingToolbarLayout mCollapsingToolbar;
    String mEnggId,mEnggName;
    Bundle bundle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  mCollapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        ...
        if (bundle != null) {
            ...
            mEnggName=bundle.getString("name");
            Log.i(TAG, "Name &  ID: "+mEnggName +"  "+mEnggId);
            mTextViewName.setText(mEnggName);
            mId.setText(mEnggId);
...
/*
    ...
    private Bundle getData() {
        if (mEnggId != null) {
           ...
           // Toast.makeText(EngineerProfileActivity.this, "" + mEnggId, Toast.LENGTH_SHORT).show();
            ...
            bundle.putString("engineerName", mEnggName);
            return bundle;
        } else {
    ...
    public void enggViewMInterface(ArrayList<EnggFragModel> enggFragModels) {
        ...
        Log.i(TAG, "enggViewMInterface: " + enggFragModel.getEmployeeName());
    }
