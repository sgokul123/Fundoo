 ...
 */
public class SideBar_engineer extends View {
    private char[] l;
    private SectionIndexer sectionIndexter = null;
    private ListView list;
    private final int m_nItemHeight = 48;

    public SideBar_engineer(Context context) {
        super(context);
        init();
    }

    public SideBar_engineer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public SideBar_engineer(Context context, AttributeSet attrs, int defStyle) {
